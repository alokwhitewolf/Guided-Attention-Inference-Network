...
class VOC_GAIN_Updater(StandardUpdater):
	...
	def __init__(self, iterator, optimizer, no_of_classes=20, device=-1, lambd1=1, lambd2=1):
	...
	def update_core(self):
		...
		# print(np.unique(labels[0]).astype(np.int32), gt_labels)
...
class VOC_GAIN_Updater2(StandardUpdater):
